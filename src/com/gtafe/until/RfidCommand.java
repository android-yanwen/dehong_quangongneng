...
public class RfidCommand {
	...
	public byte[] URFID_read_tag(String block, String addrstart,
			String wordlen, String pass, String epcid) {
	...
	public byte[] URFID_write_tagdata(String block, String addrstart,
			String idlen, String wordlen, String pass, String epcid, String data) {
		int i;
		...
		byte[] check = new byte[2];
		sup.get_crc16(Arrays.copyOf(buffer, 11 + epclen + datalen), 11 + epclen
				+ datalen, check);
