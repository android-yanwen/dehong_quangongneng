...
public class SerialPortPreferences extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// WebAddress
		final EditTextPreference webAddress = (EditTextPreference) findPreference("WebAddress");
		webAddress.setSummary(webAddress.getText());
		webAddress.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				preference.setSummary((String)newValue);
				return true;
			}
		...
		// SystemId
		final EditTextPreference systemId = (EditTextPreference) findPreference("SystemId");
		systemId.setSummary(systemId.getText());
